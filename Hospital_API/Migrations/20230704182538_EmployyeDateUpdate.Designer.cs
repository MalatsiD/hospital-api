...
namespace Hospital_API.Migrations
{
    ...
    [Migration("20230704182538_EmployyeDateUpdate")]
    partial class EmployyeDateUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital_API.Entities.Pharmaceutical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PharmaceuticalCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PharmaceuticalCategoryId");

                    b.ToTable("Pharmaceuticals");
                });

            modelBuilder.Entity("Hospital_API.Entities.PharmaceuticalCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PharmaceuticalCategories");
                });
            ...
            modelBuilder.Entity("Hospital_API.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital_API.Entities.Employee", b =>
                {
                    b.HasOne("Hospital_API.Entities.Person", "Person")
                        .WithOne("Employee")
                        .HasForeignKey("Hospital_API.Entities.Employee", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Hospital_API.Entities.Patient", b =>
                {
                    b.HasOne("Hospital_API.Entities.Person", "Person")
                        .WithOne("Patient")
                        .HasForeignKey("Hospital_API.Entities.Patient", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Hospital_API.Entities.Pharmaceutical", b =>
                {
                    b.HasOne("Hospital_API.Entities.PharmaceuticalCategory", "PharmaceuticalCategory")
                        .WithMany("Pharmaceuticals")
                        .HasForeignKey("PharmaceuticalCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PharmaceuticalCategory");
                });

            modelBuilder.Entity("Hospital_API.Entities.PharmaceuticalCategory", b =>
                {
                    b.HasOne("Hospital_API.Entities.Vendor", "Vendor")
                        .WithMany("PharmaceuticalCategories")
            ...
            modelBuilder.Entity("Hospital_API.Entities.Vendor", b =>
                {
                    b.Navigation("PharmaceuticalCategories");
                });
